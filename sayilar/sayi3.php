...
<head>
    ...
    <meta charset="UTF-8">
    <title>Magazine Dergi Sayi - 3</title>
...
<div class="dup-body-wrap">
    ...
    <section class="magazines-page achivement-area">
        <div class="container-fluid cont-header">
            <div class="row">
                <div class="header-content-text"><h3 class="about-title mb-70 text-white">SAYI 3</h3></div>
            </div>
        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="about-us-content-wrapper col-md-12">
                            <iframe style="width:100%; height:90vh;" src="//e.issuu.com/embed.html#33682382/62620412"
